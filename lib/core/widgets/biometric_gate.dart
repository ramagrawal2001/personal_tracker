                    ...
                    children: [
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          icon: Icon(LucideIcons.fingerprint, color: AppColors.onPrimary, size: 20),
                          label: Text('Unlock', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: AppColors.onPrimary)),
                          onPressed: _check,
                        ),
                      ),
                      if (_failed) ...[
