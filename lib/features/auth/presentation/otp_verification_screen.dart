...
class _OtpVerificationScreenState extends State<OtpVerificationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // When embedded inside another Scaffold (showBack=false), return bare content
    if (!widget.showBack) {
      return SafeArea(
        child: SingleChildScrollView(
          padding: const EdgeInsets.all(24),
          child: _buildContent(context, isReset, hint),
        ),
      );
    }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              ..._buildContent(context, isReset, hint).children,
            ],
          ),
        ),
      ),
