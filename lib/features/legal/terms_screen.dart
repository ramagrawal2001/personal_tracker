  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Terms & Conditions', style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _para('Last updated: August 2026\n\nBy using Aspyric, you agree to these terms. Please read them carefully.'),
            _section('1. Acceptance of Terms'),
            _para('By downloading, installing, or using Aspyric ("the App"), you agree to be bound by these Terms and our Privacy Policy.'),
            ...
            _para('All content, design, and code within the App are the intellectual property of Aspyric. You may not copy, modify, or distribute any part of the App without written permission.'),
            _section('7. Limitation of Liability'),
            _para('To the maximum extent permitted by law, Aspyric shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of the App.'),
            ...
            _section('10. Contact'),
            _para('For queries: support@aspyric.app'),
